...
El script se conecta al árbol $IPC, ejecuta una transacción en FID 0 y
comprueba si se devuelve el error "STATUS_INSUFF_SERVER_RESOURCES" a
determinar si el objetivo no está parcheado contra ms17-010. Además comprueba
para códigos de error conocidos devueltos por sistemas parcheados.

Script probado en Windows XP, 2003, 7, 8, 8.1, 10, 2008, 2012 & 2016.
